(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".graduates__slider")) new swiper_core_Swiper(".graduates__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    moreElements.forEach((element => {
        if (isMobile.any()) element.classList.add("mobile");
    }));
    document.addEventListener("DOMContentLoaded", (function(e) {
        const paginationGraduates = document.querySelector(".pagination-graduates");
        console.log(paginationGraduates);
        if (paginationGraduates) {
            const paginationGraduatesBullets = paginationGraduates.querySelectorAll(".swiper-pagination-bullet");
            let year = 2021;
            console.log(paginationGraduatesBullets);
            paginationGraduatesBullets.forEach((element => {
                console.log(element);
